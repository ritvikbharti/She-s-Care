...
import { FaDna, FaHeartbeat } from "react-icons/fa"; // FaHeartbeat moved to fa (not fa6!)
import { FaPlus, FaAngleDown } from "react-icons/fa6"; // fa6-only icons
...
export default function Dashboard() {
  ...
  // State for user (from backend DB)
